...
Die Oberfläche zeigt Funktionen, deren Nutzen nicht belegt ist. Sie bleibt als Bedienoberfläche
stehen, aber die angezeigten Bewertungen sind keine geprüften Urteile.
...
The surface exposes functions whose value is not established. It stays as an interface, but the
scores it displays are not validated judgements.
